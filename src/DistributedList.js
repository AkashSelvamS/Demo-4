...
import { FaPrint } from 'react-icons/fa'; // Importing print icon from react-icons
  ...
  return (
    ...
    <h1>Paavai Inventory Management</h1>
      <div className="header">
        <h2>Distributed List</h2>
        <div className="search-container">
          <div className="search-wrapper">
            <FaSearch className="search-icon" /> {/* Search icon inside the search bar */}
            <input 
              type="text" 
              placeholder="Search..." 
              value={searchTerm} 
          ...
          <FaPrint className="print-icon" /> {/* Print icon next to the search bar */}
        </div>
      </div>
      <table>
        <thead>
